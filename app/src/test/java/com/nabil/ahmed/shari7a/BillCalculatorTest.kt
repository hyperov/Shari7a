...
class BillCalculatorTest {
    ...
    fun testTier1() {
        ...
        assertEquals(40 * 0.68 + 1.0 + cleaningFee, result.totalCost, 0.01)
    }
    ...
    fun testTier2() {
        ...
        assertEquals(expectedCost + 2.0 + cleaningFee, result.totalCost, 0.01)
    }
    ...
    fun testTier3() {
        ...
        assertEquals(150 * 0.95 + 6.0 + cleaningFee, result.totalCost, 0.01)
    }
    ...
    fun testTier4() {
        ...
        assertEquals(expectedCost + 11.0 + cleaningFee, result.totalCost, 0.01)
    }
    ...
    fun testTier5() {
        ...
        assertEquals(expectedCost + 15.0 + cleaningFee, result.totalCost, 0.01)
    }
    ...
    fun testTier6() {
        ...
        assertEquals(800 * 2.10 + 25.0 + cleaningFee, result.totalCost, 0.01)
    }
}
